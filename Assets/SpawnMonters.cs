...
public class SpawnMonters : MonoBehaviour
{
    ...
    void MakeThingToSpawn()
    {
        ...
        if ((chaseTarget != null) && (clone.gameObject.GetComponent<Chaser2>() != null))
        {
            clone.gameObject.GetComponent<Chaser2>().SetTarget(chaseTarget);
        }
    }
}